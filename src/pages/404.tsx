...
const NotFoundPage = () => {
  return (
    <>
      <main className="w-full md:h-screen grid min-h-full place-items-center bg-white py-24 px-6 sm:py-32 lg:px-8">
        <div className="text-center">
          <h1 className="font-semibold text-red-600">404</h1>
